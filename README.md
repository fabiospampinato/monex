...
- **Much smaller**: Compared to those libraries Monex requires ~35MB fewer code to be installed for it to work (~5MB vs ~40MB), which from a security perspective is a nice feature if you need to install this on a sensitive machine, like your personal machine or a server.
